...
@Component({
  ...
  template: `
    <app-page-header [title]="isEditMode ? 'Benutzer bearbeiten' : 'Benutzer erstellen'" subtitle="Einfacher Name für die Zuordnung von Workouts."></app-page-header>
    ...
    <div class="card card-pad stack">
      <form class="stack" [formGroup]="form" (ngSubmit)="save()">
        <div class="field">
          ...
          <div class="error" *ngIf="username.invalid && username.touched">Username ist erforderlich (max. 100 Zeichen).</div>
        </div>
...
export class UserFormPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.api.getById(this.userId).subscribe((user) => {
  ...
  save(): void {
    ...
    const request$ = this.isEditMode && this.userId != null ? this.api.update(this.userId, payload) : this.api.create(payload);
