...
describe('WorkoutApiService', () => {
  ...
  const baseUrl = 'http://localhost:8081/api/workouts';
  ...
  it('manages exercises inside a workout', () => {
    ...
    let req = httpMock.expectOne(`${baseUrl}/3/exercises`);
    expect(req.request.method).toBe('GET');
